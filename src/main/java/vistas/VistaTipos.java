...
public class VistaTipos extends javax.swing.JFrame {
    ...
    public void mostrarDatos(){
        ...
        for(int i=0; i<tipos.size();i++){
            ...
            modelo.setValueAt(tipos.get(i).getNombre(),i,0);
        }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(tfTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(26, 26, 26)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(jtDAto.getSelectedRow()<0){
            ...
            this.tipos.remove(this.jtDAto.getSelectedRow());
            this.mostrarDatos();
        }
